        ...
        try {
            ...
            setTimeout(() => {
                if (response.success) {
                    ...
                    // Handle PDF errors with advanced error modal
                    if (window.PDFFallbackComponent && (
                        response.error?.includes('PDF extraction failed') ||
                        response.error?.includes('PDF processing failed') ||
                        response.error?.includes('tidak dapat diekstrak')
                    )) {
                        PDFFallbackComponent.handleAPIError(response, 'plagiarism-check');
                    } else {
            ...
            <div class="detailed-results">
                ...
                <div class="results-grid">
                    ${data.detailedResults.map((result, index) => {
                        ...
                        // Debug logging
                        console.log('Result item:', index, 'Has detailedAnalysis:', !!result.detailedAnalysis, 'isAdvanced:', result.isAdvanced);
                        ...
                        <div class="result-item" data-index="${index}">
                            <div class="result-header">
                                <div class="filename">
                                    ...
                                    ${result.isAdvanced ? '<span class="advanced-badge">🚀 Advanced</span>' : ''}
                                </div>
                            ...
                            <div class="algorithm-breakdown">
                                ${(result.detailedAnalysis && result.isAdvanced) ? `
                                    <div class="algorithm-header">
                                        <small style="font-weight: 600; color: #3498db;">🚀 Advanced Multi-Level Analysis</small>
                                    </div>
                                    <div class="advanced-breakdown">
                                        <div class="algorithm-item highlight">
                                            <small>🧠 Semantic Level</small>
                                            <div class="algorithm-score">${result.detailedAnalysis.semanticLevel}%</div>
                                        </div>
                                        <div class="algorithm-item">
                                            <small>📝 Word Level</small>
                                            <div class="algorithm-score">${result.detailedAnalysis.wordLevel}%</div>
                                        </div>
                                        <div class="algorithm-item">
                                            <small>🏗️ Structural Level</small>
                                            <div class="algorithm-score">${result.detailedAnalysis.structuralLevel}%</div>
                                        </div>
                                        <div class="algorithm-item">
                                            <small>🔤 Character Level</small>
                                            <div class="algorithm-score">${result.detailedAnalysis.characterLevel}%</div>
                                        </div>
                                        <div class="algorithm-item">
                                            <small>👤 Entity Filtered</small>
                                            <div class="algorithm-score">${result.detailedAnalysis.entityFiltered}%</div>
                                        </div>
                                        <div class="algorithm-item">
                                            <small>📊 Smart N-gram</small>
                                            <div class="algorithm-score">${result.detailedAnalysis.ngramSimilarity}%</div>
                                        </div>
                                    </div>
                                    <div class="algorithm-separator"></div>
                                    <div class="traditional-breakdown">
                                        <div class="algorithm-header">
                                            <small style="font-weight: 600; color: #7f8c8d;">📋 Traditional Analysis (Comparison)</small>
                                        </div>
                                        <div class="algorithm-item">
